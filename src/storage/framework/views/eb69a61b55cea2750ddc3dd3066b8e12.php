...
<head>
    ...
    <meta name="description" content="<?php echo e($metaDescription ?? 'Formations PDF premium sur les soudeuses à points par Mang-Ky Ha, expert industriel batteries lithium.'); ?>">
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center gap-8">
                    <a href="<?php echo e(route('formations.index')); ?>" class="text-gray-300 hover:text-white transition-colors">
                        Formations
                    </a>
                    <a href="<?php echo e(route('formateur')); ?>" class="text-gray-300 hover:text-white transition-colors">
                        Le Formateur
                    </a>
                ...
                <div class="flex items-center gap-4">
                    <!-- Cart -->
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative p-2 text-gray-400 hover:text-white transition-colors">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 mt-2 w-48 bg-dark-lighter rounded-lg shadow-xl border border-gray-700 py-2 hidden group-hover:block">
                                <a href="<?php echo e(route('account.downloads')); ?>" class="block px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Mes téléchargements
                                </a>
                                <a href="<?php echo e(route('account.orders')); ?>" class="block px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Mes commandes
                                </a>
                                <a href="<?php echo e(route('account.profile')); ?>" class="block px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Mon profil
                                </a>
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <hr class="my-2 border-gray-700">
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 text-accent hover:bg-gray-700">
                                        Administration
                                    </a>
                                <?php endif; ?>
                                <hr class="my-2 border-gray-700">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-300 hover:text-white transition-colors">
                            Connexion
                        </a>
    ...
    <footer class="bg-dark-lighter border-t border-gray-800 mt-20">
        <div class="container mx-auto px-4 py-12">
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="<?php echo e(route('formations.level', 1)); ?>" class="hover:text-white transition-colors">Niveau Débutant</a></li>
                        <li><a href="<?php echo e(route('formations.level', 2)); ?>" class="hover:text-white transition-colors">Niveau Intermédiaire</a></li>
                        <li><a href="<?php echo e(route('formations.level', 3)); ?>" class="hover:text-white transition-colors">Niveau Expert</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="<?php echo e(route('mentions-legales')); ?>" class="hover:text-white transition-colors">Mentions légales</a></li>
                        <li><a href="<?php echo e(route('cgv')); ?>" class="hover:text-white transition-colors">CGV</a></li>
                        <li><a href="<?php echo e(route('confidentialite')); ?>" class="hover:text-white transition-colors">Confidentialité</a></li>
            ...
            <div class="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> Spot Welding Pro. Tous droits réservés.</p>
            </div>
        </div>
    </footer>
