...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Formations PDF premium sur les soudeuses à points par Mang-Ky Ha, expert industriel batteries lithium.'); ?>">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak class="absolute right-0 mt-2 w-48 bg-darkcard rounded-lg shadow-xl border border-gray-700 py-2">
                                ...
                                <?php if(auth()->user()->hasRole('admin')): ?>
                                    ...
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 text-primary hover:bg-gray-700">
                                        Administration
                                    </a>
                                <?php endif; ?>
                                <hr class="my-2 border-gray-700">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="hidden sm:inline-flex px-4 py-2 bg-primary hover:bg-primary/80 text-white font-medium rounded-lg transition-colors">
                            S'inscrire
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="<?php echo e(route('formations.index')); ?>" class="hover:text-white transition-colors">Toutes les formations</a></li>
                    </ul>
                </div>
