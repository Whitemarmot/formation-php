<?php $__env->startSection('title', 'Panier - Spot Welding Pro'); ?>
...
<div class="py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-darkcard rounded-xl p-12 text-center border border-gray-700">
            ...
            <a href="<?php echo e(route('formations.index')); ?>" class="inline-block px-6 py-3 bg-primary hover:bg-primary/80 text-white font-medium rounded-lg transition-colors">
                Voir les formations
            </a>
        </div>
        <?php else: ?>
        <div class="space-y-6">
            ...
            <div class="bg-darkcard rounded-xl p-6 border border-gray-700 flex items-center gap-6">
                ...
                <div class="flex-grow">
                    <h3 class="text-lg font-semibold text-white"><?php echo e($item->formation->title); ?></h3>
                    <p class="text-gray-400 text-sm"><?php echo e($item->formation->level); ?></p>
                </div>
                <div class="text-right">
                    <p class="text-xl font-bold text-primary"><?php echo e(number_format($item->formation->price, 2, ',', ' ')); ?> €</p>
            ...
            <div class="bg-darkcard rounded-xl p-6 border border-primary/50">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-3xl font-bold text-primary"><?php echo e(number_format($total, 2, ',', ' ')); ?> €</span>
                </div>

                <div class="grid sm:grid-cols-2 gap-4">
                    <a href="<?php echo e(route('checkout.stripe')); ?>" class="flex items-center justify-center gap-2 py-4 bg-[#635BFF] hover:bg-[#635BFF]/80 text-white font-semibold rounded-xl transition-colors">
                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.594-7.305h.003z"/>
                        </svg>
                        Payer avec Stripe
                    </a>
                    <a href="<?php echo e(route('checkout.paypal')); ?>" class="flex items-center justify-center gap-2 py-4 bg-[#0070BA] hover:bg-[#0070BA]/80 text-white font-semibold rounded-xl transition-colors">
                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
